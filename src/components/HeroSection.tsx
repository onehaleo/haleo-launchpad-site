      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-haleo-gray mb-12 max-w-4xl mx-auto leading-relaxed px-4">
            Haleo builds simple, scalable automation systems for solopreneurs — so you can ditch the chaos and get back to what you do best.
          </p>
          <p className="text-base sm:text-lg md:text-xl text-haleo-gray mb-12 max-w-3xl mx-auto leading-relaxed px-4 -mt-8">
            Custom templates, AI agents, and business workflows that scale with your growth.
          </p>
